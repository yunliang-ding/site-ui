...
export default ({
  ...
  if (checkable) {
    ...
    if (_columns[0] && _columns[0].dataIndex !== "sui-checked-930226") {
      // 没有添加1项
    ...
    <Spin loading={loading}>
      <div className="sui-table-wrapper" style={style}>
        ...
        {showFixed && fixedLeft.length > 0 && (
          <div className="sui-table-fixed sui-table-fixed-left">
        ...
        {showFixed && fixedRight.length > 0 && (
          <div className="sui-table-fixed sui-table-fixed-right">
            <div className="sui-table-header">
