  ...
  return (
    <>
      <div className={className} style={style}>
        <div
          ref={selectionRef}
          className="sui-select-selection"
          onClick={() => {
            if (disabled) return;
            setopen(!_open);
          }}
        ...
        <>
          {_options.length > 0 ? (
            _options.map((option) => {
              let className =
                option.value === _value
                  ? "sui-select-dropdown-menu sui-select-dropdown-menu-selected"
                  : "sui-select-dropdown-menu";
              option.disabled &&
                (className += " sui-select-dropdown-menu-disabled");
              return (
                <div
                  key={option.key}
                  className={className}
